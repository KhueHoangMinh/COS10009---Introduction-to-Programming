...
class GameWindow < Gosu::Window
  ...
  def draw
    ...
    @background_image.draw(@shape_x, 0, z = ZOrder::BACKGROUND)
    draw_quad(@shape_xx - 20, @shape_yy -20, Gosu::Color::BLUE,@shape_xx + 20, @shape_yy -20, Gosu::Color::BLUE,@shape_xx - 20, @shape_yy +20, Gosu::Color::BLUE,@shape_xx+ 20, @shape_yy +20, Gosu::Color::BLUE,ZOrder::MIDDLE)
